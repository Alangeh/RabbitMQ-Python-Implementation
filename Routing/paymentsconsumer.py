...
def on_message_received(ch, meethod, properties, body):
    print(f"Payments Service - new message: {body}")
...
channel.queue_bind(exchange='topicexchange', queue=queue.method.queue, routing_key='#.payments') # the #. represents anything before the word 'payment'
